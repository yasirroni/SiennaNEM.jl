...
precision = 1
df_bus_latlong_range = combine(groupby(df_generator[:, [:id_bus, :latitude, :longitude]], :id_bus),
...
# ─────┼──────────────────────────────────────────────────────────────────
#    1 │      1         -19.4         -16.8          145.5          146.9
#    2 │      2         -23.6         -22.8          145.3          149.5
#    3 │      3         -23.9         -23.8          151.2          151.3
#    4 │      4         -27.7         -27.1          150.9          153.1
#    5 │      5         -30.6         -30.5          151.6          151.7
#    6 │      6         -33.5         -33.4          150.1          150.2
#    7 │      7         -34.6         -32.7          150.8          151.5
#    8 │      8         -36.4         -35.1          147.0          148.5
#    9 │      9         -38.3         -36.1          144.9          148.2
#   10 │     10         -42.9         -41.1          145.1          147.4
#   11 │     11         -35.2         -33.3          135.8          139.1
#   12 │     12         -37.7         -37.6          140.4          140.9

df_bus = leftjoin(df_bus, df_bus_latlong_range, on=:id_bus)
